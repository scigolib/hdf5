...
# Add the library
go get github.com/scigolib/hdf5@v0.11.4-beta
```
...
func main() {
    ...
    fmt.Printf("Library version: v0.11.4-beta\n")
}
```
...
**Problem**:
```
go: github.com/scigolib/hdf5@v0.11.4-beta: reading github.com/scigolib/hdf5/go.mod at revision v0.11.4-beta: unknown revision v0.11.4-beta
```
